package org.oopscraft.apps.module.batch.sample;
...
import org.oopscraft.apps.module.batch.sample.tasklet.CreateSampleTasklet;
import org.oopscraft.apps.module.batch.sample.tasklet.VerifySampleBackupTasklet;
import lombok.extern.slf4j.Slf4j;
import org.oopscraft.apps.module.core.sample.dao.SampleErrorRepository;
import org.oopscraft.apps.module.core.sample.dto.QSampleEntity;
...
@Slf4j
public class DbToDbJob extends AbstractJob {
    ...
    public ItemReader<SampleEntity> sampleReaderWithQueryDsl(int limit) {
        ...
        JPAQuery<SampleEntity> query = new JPAQuery<>();
        query.select(qSampleEntity)
                .from(qSampleEntity)
                .limit(limit);
