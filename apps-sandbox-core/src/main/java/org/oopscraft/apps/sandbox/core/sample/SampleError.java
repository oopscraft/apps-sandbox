...
public class SampleError {
     ...
     * @return sample
     */
    public static SampleError from(SampleEntity sampleEntity) {
        ModelMapper modelMapper = new ModelMapper();
        return modelMapper.map(sampleEntity, SampleError.class);
    }
     ...
     */
    public static SampleError from(SampleVo sampleVo) {
        ModelMapper modelMapper = new ModelMapper();
        return modelMapper.map(sampleVo, SampleError.class);
    }
