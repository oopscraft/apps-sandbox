...
import org.oopscraft.apps.sandbox.batch.sample.mapper.DbToDbWithQueryDslToMybatisMapper;
...
@BatchComponentScan
public class DbToDbWithQueryDslToMybatisJob extends AbstractJob {
