...
@Slf4j
@BatchComponentScan
public class FileToFileWithDelimiterToFixedLengthJob extends AbstractJob {
    ...
    public void initialize(BatchContext batchContext) {
        ...
        // defines
        inputFilePath = BatchConfig.getDataDirectory(this) + String.format("input_sample_%s.tsv", getBatchContext().getBaseDate());
     ...
     * @return
     */
    public FixedLengthFileItemWriter<SampleBackupVo> fileItemWriter() {
        return createFixedLengthFileItemWriterBuilder(SampleBackupVo.class)
                .name("fileItemWriter")
